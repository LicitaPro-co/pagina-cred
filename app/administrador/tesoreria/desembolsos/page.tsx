...
export default async function DesembolsosTesoreriaPage({
  searchParams,
}: Props) {
  ...
  let consulta = supabase
    ...
    `)
    .eq("tipo", "egreso")
    .eq("categoria", "desembolso_credito")
    ...
    <main className="min-h-screen px-5 py-8 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <header className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-3 max-w-2xl leading-7 text-slate-600">
              Consulta las salidas de dinero relacionadas
              con créditos desembolsados.
            </p>
          </div>
        ...
        <section className="mt-8 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
          <Indicador
            etiqueta="Total desembolsado"
            valor={formatearDinero(
              totalConfirmado,
            )}
            descripcion="Egresos confirmados"
          />

          <Indicador
            etiqueta="Operaciones confirmadas"
            valor={`${
              registros.filter(
                (movimiento) =>
                  movimiento.estado ===
            ...
            descripcion="Desembolsos contabilizados"
          />
          ...
          <Indicador
            ...
            descripcion="Operaciones sin confirmar"
          ...
          <Indicador
            ...
            descripcion="Movimientos anulados"
          />
        </section>
        ...
        <section className="mt-6 overflow-hidden rounded-[28px] border border-[#eadfce] bg-white">
          {!registros.length ? (
            <div className="p-8 text-slate-600">
              No existen desembolsos con los filtros
              seleccionados.
            </div>
          ) : (
                    ...
                    (movimiento) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-6 py-5 font-black text-rose-700">
                            -
                            {formatearDinero(
                              Number(
                                movimiento.valor,
